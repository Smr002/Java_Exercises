...
public class ATM {
    ...
    private static void registerAccount() throws FileNotFoundException {
        ...
        writeToFile(accounts.get(accounts.size() - 1));
 ...
 */
private static void writeToFile(Account account) throws FileNotFoundException {
    File file = new File("BankCOS.txt");

    try (PrintWriter output = new PrintWriter(new FileOutputStream(file, true))) {
        if (file.exists()) {
            System.out.println("The file 'BankCOS.txt' already exists");
          /*   Scanner scanner = new Scanner(file);
            ...
            */
            ...
            System.out.println("The new file is open");
        }

      
        output.print(account.getClass().getSimpleName()+" " );
        output.print(account.getId() +" ");
        output.print(account.getName()+" " );
        output.println(account.getBalance()+" ") ;

        if (account instanceof CheckingAccount) {
            CheckingAccount checkingAccount = (CheckingAccount) account;
            output.println("Overdraft: " + checkingAccount.getOverdraft());
        }
